...
export const building: RootObjectEntryDescriptor = {
  children: {
    ...
    damage_factor: { type: Value.NUMBER, cardinality: [0, 1] },
    ...
    military_production: { type: Value.NUMBER, cardinality: [0, 1] },
    general_production: { type: Value.NUMBER, cardinality: [0, 1] },
    naval_production: { type: Value.NUMBER, cardinality: [0, 1] },
    ...
    max_fuel_building: { type: Value.NUMBER, cardinality: [0, 1] },
    fuel_silo: { type: Value.UNQUOTED, cardinality: [0, 1] },
    fuel_gain_from_states: { type: Value.NUMBER, cardinality: [0, 1] },
  },
};
