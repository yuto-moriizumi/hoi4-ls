const modifiers: Rule = {
  children: {
    aggressive: { type: Value.UNQUOTED, cardinality: [0, Infinity] },
    ai: { type: Value.UNQUOTED, cardinality: [0, Infinity] },
    air: { type: Value.UNQUOTED, cardinality: [0, Infinity] },
    army: { type: Value.UNQUOTED, cardinality: [0, Infinity] },
    autonomy: { type: Value.UNQUOTED, cardinality: [0, Infinity] },
    country: {
      type: Value.UNQUOTED,
      ...
      children: {
        ...
        cat_strategic_destruction_cost_factor: {
          type: Value.UNQUOTED,
          cardinality: [0, 1],
          defaultValue: false,
        },
        cat_battlefield_support_cost_factor: {
          type: Value.UNQUOTED,
          cardinality: [0, 1],
          defaultValue: false,
        },
        cat_operational_integrity_cost_factor: {
          type: Value.UNQUOTED,
          cardinality: [0, 1],
          defaultValue: false,
        },
        cat_base_strike_cost_factor: {
          type: Value.UNQUOTED,
          cardinality: [0, 1],
          defaultValue: false,
        },
        cat_fleet_in_being_cost_factor: {
          type: Value.UNQUOTED,
          cardinality: [0, 1],
          defaultValue: false,
        },
        cat_trade_interdiction_cost_factor: {
          type: Value.UNQUOTED,
          cardinality: [0, 1],
          defaultValue: false,
        },
    ...
    defensive: { type: Value.UNQUOTED, cardinality: [0, Infinity] },
    government_in_exile: { type: Value.UNQUOTED, cardinality: [0, Infinity] },
    intelligence_agency: {
      type: Value.UNQUOTED,
      cardinality: [0, Infinity],
      children: {
    ...
    military_advancements: { type: Value.UNQUOTED, cardinality: [0, Infinity] },
    naval: { type: Value.UNQUOTED, cardinality: [0, Infinity] },
    peace: { type: Value.UNQUOTED, cardinality: [0, Infinity] },
    politics: { type: Value.UNQUOTED, cardinality: [0, Infinity] },
    state: {
      type: Value.UNQUOTED,
      cardinality: [0, Infinity],
      children: {
    ...
    unit_leader: { type: Value.UNQUOTED, cardinality: [0, Infinity] },
    war_production: { type: Value.UNQUOTED, cardinality: [0, Infinity] },
  },
};
