    ...
    subtype: {
      ...
      children: {
        ...
        rules: {
          children: {
            ...
            enum: {
              type: Value.BOOL,
              cardinality: [0, 20],
              provide: { context: Context.GAME_RULES, scope: Scope.IDEOLOGY },
            },
          },
        },
        ...
        enum: {
          type: Value.BOOL,
          cardinality: [0, 1],
          provide: { context: Context.AI_IDEOLOGY, scope: Scope.IDEOLOGY },
        },
      },
    },
  },
...
const enums: Rule = {
  children: {
    enum: [
      {
        type: Value.UNQUOTED,
        provide: { context: Context.GAME_RULES, scope: Scope.ENUMS },
      },
      {
        type: Value.UNQUOTED,
        provide: { context: Context.AI_IDEOLOGY, scope: Scope.ENUMS },
      },
    ],
    complex_enum: {
      children: {
