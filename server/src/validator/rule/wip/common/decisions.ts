  ...
  children: {
    decision_category: {
      ...
      children: {
        ...
        icon: { type: Value.UNQUOTED, cardinality: [0, Infinity] },
        ...
        on_map_area: { cardinality: [0, Infinity] },
      ...
      children: {
        ...
        custom_cost: {
          ...
          children: {
            ...
            custom_cost_text: { type: Value.UNQUOTED },
          },
        },
        highlight_states: { cardinality: [0, 1] },
        highlight_color_before_active: { type: Value.INT, cardinality: [0, 1] },
        highlight_color_while_active: { type: Value.INT, cardinality: [0, 1] },
        timed: { cardinality: [0, Infinity] },
        mission: { cardinality: [0, Infinity] },
        state_mission: { cardinality: [0, Infinity] },
        targeted: { cardinality: [0, Infinity] },
        state_targeted: { cardinality: [0, Infinity] },
      },
    },
    enums: {
      children: {
