...
const equipment: Rule = {
  children: {
    ...
    interface_category: {
      type: Value.ENUM,
      context: Context.INTERFACE_CATEGORY,
      cardinality: [0, 1],
    },
    priority: [
      ...
      children: {
        archetype_equip: {
          children: {
            ...
            group_by: {
              type: Value.ENUM,
              context: Context.EQUIP_GROUP_BY,
              cardinality: [0, 1],
            },
        ...
        air_equip: {
          children: {
            ...
            interface_overview_category_index: {
              type: Value.INT,
              cardinality: [0, 1],
            },
            allowed_types: {
            ...
            ai_type: {
              type: Value.ENUM,
              context: Context.ALLOWED_AI_TYPE_PLANES,
              cardinality: [0, 1],
            },
          },
        },
...
const module: Rule = {
  children: {
    ...
    gui_category: {
      type: Value.ENUM,
      context: Context.MODULE_CATEGORIES,
      cardinality: [0, 1],
    },
    parent: { type: Value.UNQUOTED, cardinality: [0, 1] },
...
const critical_part: Rule = {
  children: {
    ...
    damage_instance_per_added_module: {
      type: Value.FLOAT,
      cardinality: [0, 1],
    },
